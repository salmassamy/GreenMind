    ...
    public class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                // CategoryId 3: Tools
                new Product { Id = 13, CategoryId = 3, Name = "Digging Fork", Price = 200, Desc = "High quality digging tool.", Img = "/images/Rectangle.png" },
                new Product { Id = 14, CategoryId = 3, Name = "Shovel", Price = 200, Desc = "Durable garden shovel.", Img = "/images/shovel.png" },
                new Product { Id = 15, CategoryId = 3, Name = "Square-Point Shovel", Price = 200, Desc = "Precision digging tool.", Img = "/images/T.png" },
                new Product { Id = 16, CategoryId = 3, Name = "Watering Can", Price = 200, Desc = "Easy-pour watering can.", Img = "/images/watering.png" },
                new Product { Id = 17, CategoryId = 3, Name = "Hand Cultivator", Price = 200, Desc = "Small hand tool for soil.", Img = "/images/Hand.png" },
                new Product { Id = 18, CategoryId = 3, Name = "Round-Point Shovel", Price = 200, Desc = "Versatile round shovel.", Img = "/images/point Shovel.png" }
            );
        }
